...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_campaign_contract"; // Example
    ...
    use campaign_contract::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("campaign_contract.receive".to_string()),
